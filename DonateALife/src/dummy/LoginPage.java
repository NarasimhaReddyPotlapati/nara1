...
public class LoginPage extends javax.swing.JFrame {
   ...
   //     nameSeparator.setVisible(false);
        ...
        JTextFieldname1.setVisible(false);
    ...
    private void initComponents() {
        ...
        txtVerifyCode.setFont(new java.awt.Font("Berlin Sans FB", 0, 14)); // NOI18N
        txtVerifyCode.setBorder(null);
        txtVerifyCode.setCaretColor(new java.awt.Color(30, 59, 92));
        txtVerifyCode.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtVerifyCodeFocusGained(evt);
            }
        });
        ...
        jPanel1.add(txtVerifyCode, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 640, 110, 30));
        ...
        btnverifyEmail.setText("VerifyEmail");
        btnverifyEmail.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnverifyEmailActionPerformed(evt);
            }
        });
        jPanel1.add(btnverifyEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 640, -1, 30));

        JTextFieldname1.setFont(new java.awt.Font("Berlin Sans FB", 0, 14)); // NOI18N
        JTextFieldname1.setBorder(null);
        JTextFieldname1.setCaretColor(new java.awt.Color(30, 59, 92));
        ...
        jPanel1.add(JTextFieldname1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 490, 250, 30));
...
//            }
            ...
            if(check){
            if (RadioButtonDonor.isSelected() || RadioButtonreceiver.isSelected() ) {
            ...
            user.setName(txtVerifyCode.getText());
    ...
    private void txtVerifyCodeFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtVerifyCodeFocusGained
        // TODO add your handling code here:
        txtVerifyCode.setText("");
    }//GEN-LAST:event_txtVerifyCodeFocusGained
    ...
    private void LabelTopsignUpMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LabelTopsignUpMousePressed
        ...
        JTextFieldname1.setVisible(true);
...
//                logger.log(Level.INFO, "Sending email to new user");
                    JavaMailUtil.sendMail(TextFieldemailId.getText(), JTextFielduserName.getText(),verificationCode);
//                      System.out.println()
